...
<head>
	...
	<link href="<?php echo base_url(); ?>css/showshootingstyle.css" type="text/css" rel="stylesheet" />
...
<div id="parentVerticalTab">
            ...
            <div class="resp-tabs-container hor_1 fullwidth" style="border: 0px solid !important;">
                <div>
                    <div id="" class="shhot">
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            switch (data[i].status) {
                case "Res":
                    ...
                    colorclass = "assigned assignednew";
                    func = "noActionFunc";
                    //func = "yclicked";
                    break;
                case "Busy":
                    statuschanged = "In Use";
                    colorclass = "use usenew";     // color blue
                    hideClass = "hide";
                ...
                case "Avail":
                    statuschanged = "Open";
                    colorclass = "open opennew";
                    func = "noActionFunc";
                    //func = "gclicked";
                    break;
                case "ActionNeeded":
                    statuschanged = "Action Needed";
                    colorclass = "actionneeded actionneedednew";
                    func = "rclicked";
                ...
                default :
                    ...
                    colorclass = "inactive inactivenew";
                    func = "noActionFunc";
                    //func = "bclicked";
            ...
            if (data[i].groupId == 1) {
                ...
                if (data[i].remainingtime != null && data[i].remainingtime != "" && data[i].status != "Avail" && data[i].status != "NotOper") {
                    if(data[i].isunlimited == true){
                        ...
                        //MiddleGroupHTML += '<div>Remaining Time: <span id="timeRemainss' + data[i].bayid + '"><span id="first99' + data[i].bayid + '">99</span>:<span id="second99' + data[i].bayid + '">99</span>:<span id="third99' + data[i].bayid + '">99</span>:<span id="fourth99' + data[i].bayid + '">99</span></span></div>';
