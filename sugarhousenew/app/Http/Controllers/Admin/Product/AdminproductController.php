...
class AdminproductController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if(!$product_proof->isEmpty()){
              return Redirect::back()->withErrors("Please Delete the Product's Proof of this Product");
        }else if(!$product_accessories->isEmpty()){
              return Redirect::back()->withErrors("Please Delete the Product's Accessories of this Product");
        }else if(!$product_warranty->isEmpty()){
              return Redirect::back()->withErrors("Please Delete the Product's Warranty of this Product");
        }else if(!$product_variation->isEmpty()){
              return Redirect::back()->withErrors("Please Delete the Product's Variation of this Product");
        }else{
