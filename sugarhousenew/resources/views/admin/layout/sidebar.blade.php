...
<li>
<a href="{{ url('admin/user/allusers') }}" class="{{ Request::is('admin/user/*') ? 'active' : '' }}">
...
<li class="{{ Request::is('admin/variation/allvariationtitle') ? 'active' : '' }}"><a href="{{ url('admin/variation/allvariationtitle') }}">Products Variation  Title</a></li>
<li class="{{ Request::is('admin/variation/allproductvariation') ? 'active' : '' }}"><a href="{{ url('admin/variation/allproductvariation') }}">Products Variation Price</a></li>
