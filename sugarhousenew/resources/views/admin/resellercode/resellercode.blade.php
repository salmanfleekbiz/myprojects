...
<td>@if($resellercodes)<a class="btn btn-primary" href="{{url('admin/resellercode/editresellercode')}}/{{$resellercodes->id}}">Edit Reseller Code</a>&nbsp;<!--<a class="btn btn-primary" href="{{url('admin/deleteresellercode')}}/{{$resellercodes->id}}">Delete Reseller Code</a>@else{{'No action required'}}@endif</td>-->
</tr>
@endforeach
@endif
</tbody>
