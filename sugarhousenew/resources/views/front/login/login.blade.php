...
<p class="para-theme-form"><input type="checkbox" id="btn_chk_remember" name="btn_chk_remember" value="1" /> <label for="btn_chk_remember">remember me</label> <a href="{{url('/forgotpassword')}}">Forgot Password? </a></p>
