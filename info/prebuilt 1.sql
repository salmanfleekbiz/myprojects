...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2018 at 07:28 AM
...
CREATE TABLE `pre_categories` (
  ...
  `desc` text COMMENT 'Category Description',
  `parent_id` int(7) DEFAULT '0' COMMENT 'Parent id of category',
  `image` varchar(70) DEFAULT NULL,
  `date_created` date DEFAULT NULL,
  `date_modified` date DEFAULT NULL,
  `status` int(2) DEFAULT '1' COMMENT '0 = Disable, 1 = Enable'
...
INSERT INTO `pre_categories` (`id`, `name`, `desc`, `parent_id`, `image`, `date_created`, `date_modified`, `status`) VALUES
(1, 'CMS', NULL, 0, NULL, '2018-11-19', NULL, 1),
(2, 'e-commmerce', NULL, 0, NULL, '2018-11-19', NULL, 1),
(3, 'HTML &amp; CSS', NULL, 0, NULL, '2018-11-19', NULL, 1),
(4, 'WordPress', NULL, 1, NULL, '2018-11-19', NULL, 1),
(5, 'WooCommerce', NULL, 2, NULL, '2018-11-19', NULL, 1),
(6, 'Online Store', NULL, 3, NULL, '2018-11-19', NULL, 1),
(7, 'Portfolio', NULL, 3, NULL, '2018-11-19', NULL, 1),
(8, 'Bloging', NULL, 1, NULL, '2018-11-19', NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pre_cities`
--
...
INSERT INTO `pre_cities` (`id`, `name`, `state_id`) VALUES
(1, 'Bombuflat', 1),
(2, 'Garacharma', 1),
(3, 'Port Blair', 1),
(4, 'Rangat', 1),
...
--
-- Table structure for table `pre_countries`
--

CREATE TABLE `pre_countries` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `pre_countries`
--

INSERT INTO `pre_countries` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
--
-- Table structure for table `pre_industries`
--

CREATE TABLE `pre_industries` (
  `id` int(11) NOT NULL,
  `name` text NOT NULL,
...
--
-- Dumping data for table `pre_industries`
--

INSERT INTO `pre_industries` (`id`, `name`, `status`, `date_created`, `date_modified`) VALUES
(1, 'Volvo', 1, '2018-11-27 00:00:00', NULL),
(2, 'Opel', 1, '2018-11-27 00:00:00', NULL);
...
CREATE TABLE `pre_packages` (
  ...
  `package_discount` int(2) DEFAULT '0' COMMENT 'discount in percentage',
  `package_type` int(3) DEFAULT '0' COMMENT '0 = One Time, 1 = One Time + Monthly, 3 = Monthly',
  `date_created` date DEFAULT NULL,
  `date_modified` date DEFAULT NULL,
  `status` tinyint(1) DEFAULT '0' COMMENT '0 = disable, 1 = enable'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pre_payments` (
  `id` int(9) NOT NULL COMMENT 'Payment ID',
  `user_id` bigint(20) DEFAULT '0' COMMENT 'Id of the user who make this payment',
  `webapp_id` int(7) DEFAULT '0' COMMENT 'Webapp id for which this payment made',
  `amount_paid` float DEFAULT '0' COMMENT 'Amount paid by user',
  `payment_date` datetime DEFAULT NULL,
  `gateway` varchar(25) DEFAULT NULL COMMENT 'Payment Gateways',
  `gateway_returns` text,
  `status` int(2) DEFAULT '0' COMMENT '0 = Decline, 1 = Pending, 2 = Accepted, 3 = Canceled'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `pre_settings`
--
...
INSERT INTO `pre_settings` (`ID`, `Site_Title`, `Admin_Title`, `Email`, `Address`, `Phone`, `Website`, `Facebook`, `Twitter`, `Linkedin`, `Timezone`, `SMTP_Host`, `SMTP_Email`, `SMTP_Pass`, `SMTP_Port`, `LastUpdated`) VALUES
(1, 'OC Buyback', 'OC Buyback | Admin', 'support@ocbuyback.com', '126 Viking Ave, Brea, CA, 92821', '657-286-8274', 'www.ocbuyback.com', '', '', '', 'America/Chicago', 'mail.ocbuyback.tk', 'support@ocbuyback.tk', 'Devs@321$', 465, '2017-02-23 11:50:41');

-- --------------------------------------------------------

--
-- Table structure for table `pre_states`
--
...
--
-- Dumping data for table `pre_states`
--

INSERT INTO `pre_states` (`id`, `name`, `country_id`) VALUES
...
--
-- Table structure for table `pre_themes`
--

CREATE TABLE `pre_themes` (
  `theme_id` int(7) NOT NULL,
  `theme_name` varchar(50) DEFAULT NULL,
  `theme_desc` text COMMENT 'Theme description',
...
--
-- Dumping data for table `pre_themes`
--

INSERT INTO `pre_themes` (`theme_id`, `theme_name`, `theme_desc`, `image1`, `image2`, `date_created`, `date_modified`, `status`) VALUES
(1, 'test', 'testing', 'image1.jpg', 'image2.jpg', '2018-11-27', NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `pre_theme_to_category`
--

CREATE TABLE `pre_theme_to_category` (
  `theme_id` int(7) DEFAULT '0',
  `category_id` int(7) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `pre_users` (
  ...
  `date_created` date DEFAULT NULL,
  `date_modified` date DEFAULT NULL,
  `status` int(2) DEFAULT '0' COMMENT '0 = Pending Verification, 1 = Activated, 2 = Deactivated, 3 = Suspended, 4 = Deleted'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `pre_user_details`
--

CREATE TABLE `pre_user_details` (
  `id` bigint(20) NOT NULL,
  `user_id` bigint(20) DEFAULT '0' COMMENT 'User_id of this user details',
  `email` varchar(70) DEFAULT NULL COMMENT 'Email of this user: should be unique',
  `first_name` varchar(50) DEFAULT NULL,
  `last_name` varchar(50) DEFAULT NULL,
  `business_name` varchar(50) DEFAULT NULL,
  `industry_id` int(3) DEFAULT '0',
  `contact_preference` tinyint(1) DEFAULT '0' COMMENT '0 = email, 1 = phone',
  `address_1` varchar(100) DEFAULT NULL,
  `address_2` varchar(100) DEFAULT NULL,
  `city` varchar(40) DEFAULT NULL,
  `state` int(7) DEFAULT '0',
  `country` int(4) DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `pre_webapp`
--

CREATE TABLE `pre_webapp` (
  `webapp_id` bigint(20) NOT NULL COMMENT 'User''s web application id',
  `user_id` bigint(20) DEFAULT '0',
  `website_name` varchar(50) DEFAULT NULL,
  `domain` varchar(100) DEFAULT NULL,
  `theme_id` int(7) DEFAULT '0',
  `customization_details` text COMMENT 'Customizations requested by user at the time of order',
  `package_id` int(2) DEFAULT '0',
  `auto_renew` tinyint(1) DEFAULT '0' COMMENT '0 = No, 1 = Yes',
  `date_created` date DEFAULT NULL,
  `date_modified` date DEFAULT NULL,
  `status` int(2) DEFAULT '0' COMMENT '0 = Deactive, 1 = active, suspended'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Indexes for table `pre_cities`
--
ALTER TABLE `pre_cities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pre_countries`
--
ALTER TABLE `pre_countries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pre_industries`
--
ALTER TABLE `pre_industries`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `pre_payments`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_pre_payments` (`user_id`);

--
-- Indexes for table `pre_settings`
--
ALTER TABLE `pre_settings`
  ADD PRIMARY KEY (`ID`);

--
-- Indexes for table `pre_states`
--
ALTER TABLE `pre_states`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `pre_themes`
--
ALTER TABLE `pre_themes`
...
--
-- Indexes for table `pre_user_details`
--
ALTER TABLE `pre_user_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `FK_pre_user_details` (`user_id`);

--
-- Indexes for table `pre_webapp`
--
ALTER TABLE `pre_webapp`
  ADD PRIMARY KEY (`webapp_id`),
  ADD KEY `FK_pre_webapp` (`user_id`),
  ADD KEY `FK_pre_webapp_theme` (`theme_id`),
  ADD KEY `FK_pre_webapp_package` (`package_id`);
...
--
-- AUTO_INCREMENT for table `pre_cities`
--
ALTER TABLE `pre_cities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2322;

--
-- AUTO_INCREMENT for table `pre_countries`
--
ALTER TABLE `pre_countries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;

--
-- AUTO_INCREMENT for table `pre_industries`
--
ALTER TABLE `pre_industries`
...
--
ALTER TABLE `pre_packages`
  MODIFY `package_id` int(2) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pre_payments`
--
ALTER TABLE `pre_payments`
  MODIFY `id` int(9) NOT NULL AUTO_INCREMENT COMMENT 'Payment ID';

--
-- AUTO_INCREMENT for table `pre_settings`
--
ALTER TABLE `pre_settings`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pre_states`
--
ALTER TABLE `pre_states`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2182;

--
-- AUTO_INCREMENT for table `pre_themes`
--
ALTER TABLE `pre_themes`
  MODIFY `theme_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT for table `pre_user_details`
--
ALTER TABLE `pre_user_details`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pre_webapp`
--
ALTER TABLE `pre_webapp`
  MODIFY `webapp_id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'User''s web application id';
...
--
ALTER TABLE `pre_payments`
  ADD CONSTRAINT `FK_pre_payments` FOREIGN KEY (`user_id`) REFERENCES `pre_users` (`user_id`);

--
-- Constraints for table `pre_user_details`
--
ALTER TABLE `pre_user_details`
  ADD CONSTRAINT `FK_pre_user_details` FOREIGN KEY (`user_id`) REFERENCES `pre_users` (`user_id`);

--
-- Constraints for table `pre_webapp`
--
ALTER TABLE `pre_webapp`
  ADD CONSTRAINT `FK_pre_webapp` FOREIGN KEY (`user_id`) REFERENCES `pre_users` (`user_id`),
  ADD CONSTRAINT `FK_pre_webapp_package` FOREIGN KEY (`package_id`) REFERENCES `pre_packages` (`package_id`),
  ADD CONSTRAINT `FK_pre_webapp_theme` FOREIGN KEY (`theme_id`) REFERENCES `pre_themes` (`theme_id`);
COMMIT;
