...
<div class="form-group">
  ...
  <div class="col-sm-9 col-xs-12">
    <input 
      ...
      value="@if(old('title')){!! old('title') !!}@elseif(isset($propertytype->title)){!!$propertytype->title!!}@endif"
      class="form-control"
      />
  </div>
</div>
<div class="form-group">
  ...
  <div class="col-sm-9 col-xs-12">
    ...
    @elseif(isset($propertytype->is_active) and ($propertytype->is_active=='1')){{'checked="checked"'}}@endif />
    Active</label>
  </div>
</div>
@if(old('tmp_img_path_main'))
<?php $image_path = Request::old('tmp_img_path_main'); ?>
@elseif(isset($propertytype->image) and is_file($propertytype->image))
<?php $image_path = str_replace('/','|',$propertytype->image); ?>
@else
<?php $image_path = 'NA'; ?>
@endif
<div class="form-group">
