      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="meta_keyword" type="text" class="form-control" 
            value="@if(old('meta_keyword')){!! old('meta_keyword') !!}@elseif(isset($page->meta_keyword)){!!$page->meta_keyword!!}@endif"
            />
        </div>
      </div>
    </div>
      ...
      <div class="form-group">
        ...
        <div class="col-sm-8 col-xs-12">
          <input name="meta_descript" type="text" class="form-control" 
            value="@if(old('meta_descript')){!! old('meta_descript') !!}@elseif(isset($page->meta_descript)){!!$page->meta_descript!!}@endif"
            />
        </div>
      </div>
    </div>
