    ...
    <fieldset class="col-md-12 table-bordered">
      ...
      <div class="col-md-6">
        ...
        <div class="form-group row">
          ...
          <div class="col-md-8 set-deatail">{{$reservation->adults}}</div>
        </div>
        <div class="form-group row">
          <label class="col-md-4 control-label">Children</label>
          <div class="col-md-8 set-deatail">{{$reservation->children}}</div>
        </div>
        <div class="form-group row">
          <label class="col-md-4 control-label">Pets</label>
          <div class="col-md-8 set-deatail">{{$reservation->pets}}</div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="form-group row">
