...
<html>
  ...
  <body class="skin-green sidebar-mini">
					...
					<ul class="nav navbar-nav">
						...
						<!--<li class="dropdown messages-menu">
							...
							<ul class="dropdown-menu">
								...
								<li class="footer"><a href="{{url('admin/reservations')}}">See All Reservations / scroll</a><small></small></li>
							</ul>
						</li>
						...
						<ul class="dropdown-menu">
						  ...
						  <li class="footer"><a href="{{url('admin/transactions')}}">View all transactions/ scroll</a><small></small></li>
						</ul>
					  </li>
    ...
    <script type='text/javascript'>
      ...
      $(document).on("click", "#iframeModal, #iframeModalSimple", function () {
