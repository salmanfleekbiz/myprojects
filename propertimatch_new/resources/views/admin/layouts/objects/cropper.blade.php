...
<article class="col-md-3" id="crop-pictuer-{{$number}}">
  ...
  <input class="imageid" name="image_id" id="image_id" type="hidden" value="{{$db_id}}" >
  ...
  <div id="{{$number}}" class="image-view image-view-{{$ratio}} crop-initiate">
    ...
    <input type="hidden" name="imgserc" id="imgserc" value="{{asset($preview_image)}}">
...
<!--                   @if(is_file($preview_image))
                  <img id="image" src="{{asset($preview_image)}}">
                  @endif -->
                </div>
              ...
              <div class="col-md-3 text-center">
                 ...
                 <button type="button" class="btn btn-primary image-btns" data-method="rotate" data-option="-90" title="Rotate -90 degrees">Rotate Left</button>

              </div>
              <div class="col-md-3 text-center">
                 <button type="button" class="btn btn-primary image-btns" data-method="rotate" data-option="90" title="Rotate 90 degrees">Rotate Right</button>
