...
<div class="form-group">
  <label class="col-sm-3 col-xs-12 control-label">Slide Link</label>
  <div class="col-sm-9 col-xs-12">
    <input 
      type="text"
      name = "slidelink"
      placeholder="Enter link here"
      value="@if(old('slidelink')){!! old('slidelink') !!}@elseif(isset($slider->slidelink)){!!$slider->slidelink!!}@endif"
      class="form-control"
      />
  </div>
</div>
