                ...
                <div class="row"> 
                  <fieldset class="my-field-set">
                    ...
                    <?php $count++; ?>
                      <li>
                        <a href="#">
                          <input type="checkbox" name="lifestyle[]" id="checkbox{{$count}}" class="css-checkbox" value="{{$single->id}}"/>
                          <label for="checkbox{{$count}}" class="css-label"> {{$single->title}}</label>
                        </a>
                      </li> 
                    <?php if($count==10) { ?>
                    </ul>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-custom clr_cstm">
                        ...
                        <select name="state_id" class="selectpicker" title="Country/Province" data-hide-disabled="true">
...
?>
  ...
  <!-- List of Properties -->
    ...
    <script>
      ...
      <h2 style="text-align: center">Sorry, no results found for your search. If you want to notify in the email when this product had came <?php echo $searh_name; ?> <a class='inline' href="#inline_content">Click Here</a></h2>
      <div style='display:none'>
      <div id='inline_content' style='padding:10px; background:#fff;'>
      <p><strong>Notify</strong></p>
      <form name="customer_notification" id="customer_notification" method="post" action="http://propertimatch.craftedium.xyz/customnotify">
        <input type="hidden" name="_token" value="{{ csrf_token() }}">
