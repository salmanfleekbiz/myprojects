...
<section id="welcome-index">
   <div class="container page-body">
      ...
      <article class="col-md-12">
         ...
         <div class="col-md-6 col-sm-6"> 
            <img class="img-responsive img-preload" data-src="{{asset(@$page_home->images->first()->image)}}" data-src-retina="{{asset(@$page_home->images->first()->image)}}" alt="{{@$page_home->title}}" src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7"> 
         </div>
      </article>
      <!-- /.row -->
      <!-- /.row -->
