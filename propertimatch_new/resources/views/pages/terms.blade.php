...
<?php $page_metas = \App\Pages::where('id', 43)->where('is_active', 1)->first(); ?>
@section('metatits')
			...
			<div class="row">        
				...
				<div class="col-xs-12">     
					...
					<div class="breadcrumbs">        
						...
						<h2 class="breadcrumbs-title">Terms of Use</h2>  
...
<h3>Disclaimer</h3>
<p>MatchPropertyDirect.com is solely a connecting site. We are not handling any Real Estate transactions or any other real estate representations. We are not responsible for or are a party to any seller or buyer representations or misrepresentations. We are not acting as a Real Estate Company or Real Estate Brokers or Real Estate Agents. We are not selling Real Estate. MPD is only connecting Potiential buyers and Potiential sellers.MPD is not liable for any harm or consequences that result from using this site. The user that signs on and also pays to post their property do so with full knowledge that they are acting sole on their own and hold MPD harmless. All users of the site are accepting all terms and conditions that are listed and posted on the site. </p>
           </div>
